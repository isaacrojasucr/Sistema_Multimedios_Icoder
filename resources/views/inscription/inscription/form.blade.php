...
</div><div class="form-group {{ $errors->has('proof') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('inscription') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('pase_cantonal') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('edition') ? 'has-error' : ''}}">
