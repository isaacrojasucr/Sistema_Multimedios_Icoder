            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/challenge/challenge/' . $challenge->id . '/edit') }}" title="Edit challenge"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $challenge->name }} </td></tr><tr><th> Cat Id </th><td> {{ $challenge->cat_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
